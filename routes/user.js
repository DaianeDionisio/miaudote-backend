...
router.put('/user/:id', authMiddleware.verifyFirebaseToken, apiControllerUser.updateUser);
router.delete('/user/:id', authMiddleware.verifyFirebaseToken, apiControllerUser.deleteUser);
